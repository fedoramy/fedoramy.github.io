...
blog_title = u'Fedora Malaysia Blog'
...
project = u'Fedora Malaysia'
copyright = u'2020, Robbi Nespu'
author = u'Robbi Nespu'
...
htmlhelp_basename = 'FedoraMalaysiadoc'
